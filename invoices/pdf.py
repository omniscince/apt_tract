...
def generate_invoice_pdf(response, invoice):
    ...
    header_data = [
        ...
        [
            ...
            Paragraph(f"Work Order Close Date: {invoice.last_edit_date.strftime('%m/%d/%Y') if invoice.last_edit_date else ''}", right_style),
        ],
        [
    ...
    if invoice.created_by:
        worker_lines.append(f"<b>Generated By:</b> {invoice.created_by.get_full_name()}")
